 ...
 *   emergency_note='운영시간 외 긴급전화 (단순 금액 정정 불가)'
 */
...
export const businessHoursDefault = pgTable('business_hours_default', {
  ...
  /** 접수 마감 — 운영 종료보다 빠를 수 있음 (예: 18:00) */
  intakeDeadline: time('intake_deadline'),
  /** 토요일 휴무 (true=휴무, false=운영) */
