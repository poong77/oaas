        ...
        <form action="/notices" method="get" className="sm:w-80">
          ...
          <label className="flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 focus-within:border-brand-500 dark:border-slate-700 dark:bg-slate-900">
            ...
            <input
              ...
              className="w-full bg-transparent text-sm placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none"
            />
          </label>
        </form>
      </div>
        ...
        <nav className="flex items-center justify-center gap-1">
          {page > 1 ? (
            <Link
              ...
              aria-label="이전"
              className="flex h-8 w-8 items-center justify-center rounded-md text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"
            >
