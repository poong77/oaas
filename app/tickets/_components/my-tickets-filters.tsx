            ...
            <button
              ...
              className={`rounded-lg px-4 py-2 text-sm font-medium transition-colors ${
                active
                  ...
                  : 'bg-[#F3F4F5] text-[#555D6D] hover:bg-[#e9eaec] dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700'
              }`}
            >
              {tab.label}
            </button>
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
        <div className="flex items-center gap-2">
          <Select
            ...
            className="h-[44px] w-full sm:w-32"
          >
          ...
          <Select
            ...
            className="h-[44px] w-full sm:w-28"
          >
            <option value="desc">최신순</option>
            <option value="asc">오래된순</option>
          </Select>
        </div>
        <label className="flex h-[44px] w-full items-center gap-2 rounded-lg border border-[#DCDEE3] bg-white px-4 dark:border-slate-700 dark:bg-slate-900 sm:w-[300px]">
          <button
            type="button"
            aria-label="검색"
