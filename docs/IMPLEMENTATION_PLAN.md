...
| LP-02 | GNB 네비게이션 | (2026-06-01 UX 재구성) 행동 기준 4개: 홈 · 도움말 찾기(`/search`) · 문의하기(`/tickets/new`) · 서비스 현황(`/status`) + 🟢 운영시간 배지(유지) + 🔔 공지(`/notices` 배지). 셀프픽스 메뉴 미사용. 푸터 연락 정보(ContactPanel) 유지 | 전체 | P1 |
